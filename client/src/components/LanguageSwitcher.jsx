  ...
  const LanguageSwitcher = () => {
    ...
    return (
      <div className="flex flex-col items-start gap-4 overflow-hidden rounded-md p-6 shadow-sm shadow-[#00000050]">
        <span className="text-center font-mono text-base font-black uppercase text-neutral-600">{t("Please select language")}</span>
        <div className="flex items-center gap-4">
          ...
          <div className="relative flex h-[50px] w-[50px] items-center justify-center">
            <input 
              ...
              className="peer z-10 h-full w-full cursor-pointer opacity-0" 
            />
            <div className="absolute h-full w-full rounded-full bg-red-100 dark:bg-red-400 p-2 shadow-sm shadow-[#00000050] ring-red-400 dark:ring-red-900 duration-300 peer-checked:scale-110 peer-checked:ring-2" />
